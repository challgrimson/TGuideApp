...
public class AlarmScheduler {
    ...
    public void setAlarm(Context context, long alarmTime, Uri reminderTask) {
        AlarmManager manager = com.example.android.tguide.reminder.AlarmManagerProvider.getAlarmManager(context);

        PendingIntent operation =
                com.example.android.tguide.reminder.ReminderAlarmService.getReminderPendingIntent(context, reminderTask);
