...
public class AlarmScheduler {
    ...
    public void setAlarm(Context context, long alarmTime, Uri reminderTask) {
        AlarmManager manager = com.delaroystudios.alarmreminder.reminder.AlarmManagerProvider.getAlarmManager(context);

        PendingIntent operation =
                com.delaroystudios.alarmreminder.reminder.ReminderAlarmService.getReminderPendingIntent(context, reminderTask);
