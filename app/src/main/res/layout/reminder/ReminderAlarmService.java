...
public class ReminderAlarmService extends IntentService {
    private static final String TAG = com.delaroystudios.alarmreminder.reminder.ReminderAlarmService.class.getSimpleName();
    ...
    public static PendingIntent getReminderPendingIntent(Context context, Uri uri) {
        Intent action = new Intent(context, com.delaroystudios.alarmreminder.reminder.ReminderAlarmService.class);
        action.setData(uri);
